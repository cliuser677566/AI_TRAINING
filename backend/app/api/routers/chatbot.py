...
@router.post("/message")
def chat_message(payload: ChatRequest, x_chatbot_debug_token: Optional[str] = Header(default=None)):
    debug_allowed = (
        payload.debug_sql
    ...
    return handle_chat_message(payload.message, payload.session_id, include_sql_debug=debug_allowed)
